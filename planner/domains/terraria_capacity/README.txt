...
;; in our experiments the first 12 problem instances are taken exactly from Savas et al.'s benchmark domains. 
;; we have taken domain12 and incremented the numeric goal limits for problems between 13-20. 