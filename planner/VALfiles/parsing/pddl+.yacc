...
c_control :
      CONTROL OPEN_BRAC   c_control_params_list CLOSE_BRAC 
       {$$ = $3; current_analysis->setControlParams($$);}
       | {$$ = NULL; current_analysis->setControlParams($$);};
...
c_durative_action_def :
    ...
    { $$= $11;
      ...
      $$->control_parameters = current_analysis->getControlParams();
      $$->parameters= $6;
      $$->dur_constraint= $10;
      delete [] $3;
      delete $8;
